...
##-------------------------以上是通过Arms模块模板创建项目时自带的，以下是因业务需求新增的----------------------------
#模块commonService中的bean类
-keep class me.jessyan.armscomponent.commonservice.**{*;}
...
#部分模块的实体类
-keep class me.jessyan.armscomponent.zhihu.mvp.model.entity.**{*;}
-keep class me.jessyan.armscomponent.gold.mvp.model.entity.**{*;}
-keep class me.jessyan.armscomponent.gank.mvp.model.entity.**{*;}