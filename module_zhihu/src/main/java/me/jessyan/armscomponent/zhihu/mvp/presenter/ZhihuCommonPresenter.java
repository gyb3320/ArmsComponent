 ...
 */
@ActivityScope
public class ZhihuCommonPresenter extends BasePresenter<ZhihuCommonContract.Model, ZhihuCommonContract.View> {
    @Inject
    ...
    @Inject
    public ZhihuCommonPresenter(ZhihuCommonContract.Model model, ZhihuCommonContract.View rootView) {
